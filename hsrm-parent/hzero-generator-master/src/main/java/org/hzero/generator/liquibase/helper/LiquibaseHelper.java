package org.hzero.generator.liquibase.helper;
...
public class LiquibaseHelper {
    ...
    public DbType dbType() {
        ...
        } else if (this.url.startsWith("jdbc:zenith")) {
            this.currentDbType = DbType.ZENITH;
        }
        return currentDbType;
    }
    ...
    public boolean isZenith() {
        return this.url.startsWith("jdbc:zenith");
    }
