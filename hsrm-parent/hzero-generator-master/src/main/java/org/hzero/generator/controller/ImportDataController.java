...
public class ImportDataController {
    ...
    public List<Mapping> getDataServices(@RequestParam String dir){
        List<Mapping> services = importDataService.getDataServices(dir);
        if (services.isEmpty()){
            return null;
        }
        return services;
    ...
    public List<Mapping> getGroovyServices(@RequestParam String dir){
        List<Mapping> services = importDataService.getGroovyServices(dir);
        if (services.isEmpty()){
            return null;
        }
        return services;
